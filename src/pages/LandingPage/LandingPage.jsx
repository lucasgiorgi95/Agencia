      ...
      <div className="service-page">
        <div className="container">
          <div className="section">
            ...
            <p>
              Porque están pensadas para cumplir un objetivo claro: que tu
              negocio reciba más consultas, más ventas o más contactos. Nos
              enfocamos en el diseño, los textos y la experiencia para que cada
              visitante haga lo que vos querés que haga.
            </p>
          </div>
          ...
          <PricingSection
            title="Inversión"
            price="Desde $170.000 ARS"
            description="Incluye diseño a medida, optimización para dispositivos móviles, textos persuasivos y configuración de métricas para medir resultados."
            disclaimer="El precio final puede variar según la cantidad de secciones, integraciones y personalizaciones solicitadas."
          />
