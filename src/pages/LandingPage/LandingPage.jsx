...
const LandingPage = () => {
  ...
  const landingSections = [
    ...
    { name: "Hero Section", description: "Título principal, subtítulo y llamada a la acción" },
    { name: "Propuesta de Valor", description: "Beneficios claros de tu producto o servicio" },
    { name: "Características", description: "Funcionalidades y ventajas específicas" },
    { name: "Testimonios", description: "Opiniones reales de clientes satisfechos" },
    ...
    { name: "Call to Action", description: "Botones estratégicos para generar conversiones" },
    { name: "Footer", description: "Información adicional y enlaces importantes" },
  ];
      ...
      <div className="service-page">
        ...
        <div className="section">
          ...
          <p>
            ...
            reciba más consultas, más ventas o más contactos. Nos enfocamos en el
            diseño, los textos y la experiencia para que cada visitante haga lo
            que vos querés que haga.
          </p>
        </div>
