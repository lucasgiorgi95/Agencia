  ...
  const websiteSections = [
    {
      ...
      description: "Presentación principal de tu negocio",
    },
    {
      name: "Sobre Nosotros",
      description: "Historia, misión y equipo de trabajo",
    },
      ...
      <div className="service-page">
        <div className="container">
          <div className="section">
            ...
            <p>
              Un sitio web profesional es la base de tu presencia digital. A
              diferencia de una landing page, incluye múltiples páginas que
              cuentan la historia completa de tu negocio, generan confianza y te
              posicionan como líder en tu sector. Es tu oficina virtual
              disponible 24/7.
            </p>
          </div>
